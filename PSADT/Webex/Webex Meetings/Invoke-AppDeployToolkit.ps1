...
$adtSession = @{
    ...
    AppProcessesToClose = @('CiscoCollabHost')  # Example: @('excel', @{ Name = 'winword'; Description = 'Microsoft Word' })
    ...
    InstallName = 'Webex Meetings'
    InstallTitle = 'Webex Meetings'
...
function Install-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Install' -FilePath 'Files\Webex.msi' -ArgumentList '/QN ACCEPT_EULA=TRUE DELETEUSERDATA=1 INSTALL_ROOT="C:\Program Files\Cisco Spark" ALLUSERS=1 ENABLEOUTLOOKINTEGRATION=1 AUTOSTART_WITH_WINDOWS=false PREVENT_PRELOGIN_UPDATES=1'
...
function Uninstall-ADTDeployment
{
   ...
   #Start-ADTProcess -FilePath '$envLocalAppData\Programs\Cisco Spark\WebexUninstaller.exe' -ArgumentList '/uninstall'
   Uninstall-ADTApplication -Name 'Webex' -ApplicationType 'MSI'
