...
function Install-ADTDeployment
{
    ...
    Remove-Item -Path "C:\ProgramData\VACO\InstalledApps\pinfix.tag" -Force -ErrorAction SilentlyContinue
...
New-Item -Path "C:\ProgramData\VACO\InstalledApps\pinfix.tag" -ItemType File -Force
