...
function Install-ADTDeployment
{
  ...
  -CloseProcesses "iexplore", "winword", "excel", "powerpnt", "outlook", "onenote", "msaccess", "visio", "project", "lync", "teams" -AllowDefer -DeferTimes 5  -CheckDiskSpace  -PersistPrompt
    ...
    Remove-Item -Path "C:\ProgramData\VACO\InstalledApps\Office-ChannelChange" -Force -ErrorAction SilentlyContinue
...
{write-host "CND Base Url registery key does not exsist."}
    ...
    $adtSession.InstallPhase = "Post-$($adtSession.DeploymentType)"
        ...
        New-Item -Path "C:\ProgramData\VACO\InstalledApps\Office-ChannelChange" -ItemType File -Force
