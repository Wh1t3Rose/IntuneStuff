...
$adtSession = @{
    # App variables.
    AppVendor = 'Lenovo'
    AppName = 'Commercial Vantage'
    AppVersion = '20.2506.39.0'
    AppArch = ''
    AppLang = 'EN'
    AppRevision = '01'
...
Show-ADTInstallationProgress
    ...
    Start-ADTProcess -FilePath "$($adtSession.DirFiles)\VantageInstaller.exe" -ArgumentList 'Uninstall','-Vantage','-SuHelper','/VERYSILENT' -WindowStyle 'Hidden' -PassThru
    ...
    Start-ADTProcess -FilePath "$($adtSession.DirFiles)\VantageInstaller.exe" -ArgumentList 'Install','-Vantage','-SuHelper','/VERYSILENT' -WindowStyle 'Hidden' -PassThru
