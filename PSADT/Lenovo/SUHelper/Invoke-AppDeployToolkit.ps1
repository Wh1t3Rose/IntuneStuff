...
Show-ADTInstallationProgress
    ...
    Start-ADTProcess -FilePath "$($adtSession.DirFiles)\SUHelper\SUHelper.exe" -ArgumentList 'autoupdate' -WindowStyle 'Hidden' -PassThru
    ...
    New-Item -Path "C:\ProgramData\VACO\InstalledApps\SUHelper.tag" -ItemType File -Force
