...
$ExeInstallerName   = 'toad-setup.exe'
$ExeUninstallerName = 'toad-setup.exe'
...
$ExeInstallArgs = "/install /qn /LOG=`"C:\Windows\Logs\Software\$InstallName.log`""

# Arguments for EXE uninstallation
$ExeUninstallArgs = "/uninstall /qn /LOG=`"C:\Windows\Logs\Software\$InstallName.log`""
