...
Start-ADTProcess -FilePath "Files\jre-8u461-windows-x64.exe" -ArgumentList '/s'
...
New-Item -Path "C:\ProgramData\VACO\InstalledApps\JRE.8_461.tag" -ItemType File -Force
