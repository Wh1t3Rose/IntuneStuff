...
$InstallName  = 'Jetbrains dotUltimate'
$ProcessName  = 'Jetbrains dotUltimate.exe'
...
$ExeInstallerName   = 'JetBrains.dotUltimate.2025.3.1.exe'
$ExeUninstallerName = 'JetBrains.dotUltimate.2025.3.1.exe'
...
$ExeUninstallerPath = 'Files\JetBrains.dotUltimate.2025.3.1.exe'

# Arguments for EXE installation
# Use double quotes so the installer log path expands `$InstallName` at runtime
$ExeInstallArgs = "/Silent=True /SpecificProductNames=dotPeek /VsVersion=17.0;16.0;15.0"

# Arguments for EXE uninstallation
$ExeUninstallArgs = "/Silent=True /SpecificProductNamesToRemove=dotPeek /VsVersion=17.0;16.0;15.0"
