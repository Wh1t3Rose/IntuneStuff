...
function Install-ADTDeployment
{
    ...
    Remove-Item -Path "C:\ProgramData\VACO\InstalledApps\dotnet-uninstall-tool" -Force -ErrorAction SilentlyContinue
    ...
    Start-ADTMsiProcess -Action 'Install' -FilePath 'Files\dotnet-core-uninstall.msi' -ArgumentList "/quiet"
...
New-Item -Path "C:\ProgramData\VACO\InstalledApps\dotnet-uninstall-tool.tag" -ItemType File -Force
...
Remove-Item -Path "C:\ProgramData\VACO\InstalledApps\dotnet-uninstall-tool.tag" -Force -ErrorAction SilentlyContinue
