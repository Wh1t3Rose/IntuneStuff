...
$InstallName  = 'SQL Server Management Studio 22'   
$ProcessName  = 'SSMS'
...
$adtSession = @{
    ...
    InstallWelcomeMessage   = 'Installing $InstallName. Please save your work before continuing.'
    UninstallWelcomeMessage = 'UnInstalling $InstallName. Please save your work before continuing.'
    CompletionMessage       = ''
...
$ExeInstallerPath = 'Files\vs_SSMS.exe'
...
Show-ADTInstallationWelcome `
    ...
    # Execute the EXE installer with the arguments from the variables section
    Start-ADTProcess -FilePath $ExeInstallerPath -ArgumentList $ExeUninstallArgs
