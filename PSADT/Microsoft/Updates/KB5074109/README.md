...
Install-Module -Name PSAppDeployToolkit -RequiredVersion 4.1.5 -Scope CurrentUser -Force
Import-Module -Name PSAppDeployToolkit -RequiredVersion 4.1.5 -Force
```

## Create PSADT Package Directory
```powershell
# Create a new package template folder using the installed PSADT module
$packageRoot = Join-Path (Get-Location) 'Update kb5067036-24H2'
