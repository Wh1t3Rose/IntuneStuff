...
$adtSession = @{
    # App variables.
    AppVendor = 'Microsoft'
    AppName = 'Visual C++ 2005-2022 AIO'
    AppVersion = ''
    AppArch = ''
    AppLang = 'EN'
    AppRevision = '01'
    ...
    InstallName = 'Visual C++ 2005-2022 AIO'
    InstallTitle = 'Visual C++ 2005-2022 AIO'
...
function Install-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath 'Files\VisualCppRedist_AIO_x86_x64.exe' -ArgumentList '/ai /gm2'
...
function Uninstall-ADTDeployment
{
   ...
   ## Uninstall-ADTApplication -Name 'Acrobat' -ApplicationType 'MSI'
    ...
    Start-ADTProcess -FilePath 'Files\VisualCppRedist_AIO_x86_x64.exe' -ArgumentList '/aiR /gm2'
