...
$adtSession = @{
    ...
    InstallTitle = 'Visual Studio Code'
...
function Install-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath 'Files\VSCodeSetup-x64-1.103.2.exe' -ArgumentList '/VERYSILENT /MERGETASKS=!runcode'
...
function Uninstall-ADTDeployment
{
   ...
   Start-ADTProcess -FilePath 'C:\Program Files\Microsoft VS Code\unins000.exe' -ArgumentList '/VERYSILENT /NORESTART'
