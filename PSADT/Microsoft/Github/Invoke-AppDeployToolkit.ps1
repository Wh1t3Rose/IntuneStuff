...
$ExeInstallerName   = 'GitHubDesktopSetup-x64.exe'
$ExeUninstallerName = 'Update.exe'
# Optional: provide a full path to the uninstaller to override the files folder.
# Example: $ExeUninstallerPath = "$env:LocalAppData\GitHubDesktop\Update.exe"
...
$ExeUninstallArgs = "--uninstall --silent"
...
function Install-ADTDeployment
{
    ...
    # Ensure EXE installer variables are initialized to $null if not defined (for MSI fallback)
