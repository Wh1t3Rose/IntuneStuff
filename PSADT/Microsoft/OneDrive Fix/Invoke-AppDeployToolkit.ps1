...
function Install-ADTDeployment
{
    ...
    Remove-Item -Path "C:\ProgramData\VACO\InstalledApps\OneDriveLaunchFix.tag" -Force -ErrorAction SilentlyContinue
    ...
    Else {
        ...
        Write-ADTLogEntry -Message 'OneDrive is not installed.'
    }
...
New-Item -Path "C:\ProgramData\VACO\InstalledApps\OneDriveLaunchFix.tag" -ItemType File -Force
