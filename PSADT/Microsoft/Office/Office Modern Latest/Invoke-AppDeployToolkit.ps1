...
function Uninstall-ADTDeployment
{
    ...
    ## Show Welcome Message, close Software with a 60 second countdown before automatically closing.
    Show-ADTInstallationWelcome -CloseProcesses @{ Name = 'outlook'; Description = $adtSession.AppName } -CloseProcessesCountdown 60

    ## Show Progress Message (with a message to indicate the application is being uninstalled).
    Show-ADTInstallationProgress -StatusMessage 'Uninstalling Any Existing Versions of Microsoft Office. Please Wait...'
    ...
    Start-ADTProcess -FilePath 'Files\setup.exe' -ArgumentList "/configure Uninstall.xml"
