...
function Install-ADTDeployment
{
    ...
    Remove-Item -Path "C:\ProgramData\VACO\InstalledApps\wintrustverify.tag" -Force -ErrorAction SilentlyContinue
...
# Create the 64-bit registry key and set the value
...
# Create the 32-bit Wow6432Node registry key and set the value
...
New-Item -Path "C:\ProgramData\VACO\InstalledApps\wintrustverify.tag" -ItemType File -Force
