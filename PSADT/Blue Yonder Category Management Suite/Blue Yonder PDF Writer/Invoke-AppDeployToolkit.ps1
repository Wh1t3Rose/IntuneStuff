...
$InstallName  = 'PDF Writer'
$ProcessName  = 'PDFWriter.exe'
...
# Arguments for MSI installation (PDF Writer)
$MsiInstallerName = 'PDFWriter.msi'
$MsiInstallerPath = ''
...
$MsiInstallArgs = "INSTALLDIR=`"C:\BlueYonder\Category Management\PDFWriter`" JDAPDFWRITERMODE=2 /qn /l*v `"$MsiInstallLog`""
...
function Install-ADTDeployment
{
    ...
    if (-not $skipExeInstall) {
        ...
        Write-ADTLogEntry -Message "MSI install configured; skipping EXE/Zero-Config install block." 'INFO'
    }
