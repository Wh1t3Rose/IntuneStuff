...
$adtSession = @{
    ...
    AppProcessesToClose = @( @{ Name = '$InstallName'; Description = $InstallName })
    ...
    InstallName = 'DWGSeePro' ## Must be set to contain part of name of Window Title
    InstallTitle = '' ## Optional
