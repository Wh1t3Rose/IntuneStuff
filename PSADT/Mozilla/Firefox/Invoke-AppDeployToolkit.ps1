...
$adtSession = @{
    ...
    InstallName = 'Mozilla Firefox'
    InstallTitle = 'Mozilla Firefox'
...
function Install-ADTDeployment
{
   ...
   Start-ADTProcess -FilePath 'Files\Firefox Installer.exe' -ArgumentList '/DesktopShortcut=false /TaskbarShortcut=false' -WindowStyle "Hidden"
...
function Uninstall-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath "C:\Program Files\Mozilla Firefox\uninstall\helper.exe" -ArgumentList "/S"
