...
$adtSession = @{
    # App variables.
    AppVendor = 'Microsoft'
    AppName = 'Windows 11 Security Update for April 2025'
    AppVersion = '1.0'
    AppArch = ''
    AppLang = 'EN'
    AppRevision = '01'
...
function Install-ADTDeployment
{
    ...
    Remove-Item -Path "C:\ProgramData\VACO\InstalledApps\KB5055523.tag" -Force -ErrorAction SilentlyContinue
    ...
    If (-not (Test-ADTMSUpdates -KbNumber 'KB5055523')) {
        Install-ADTMSUpdates -Directory 'Files\' -Wait
    }
    ...
    $adtSession.InstallPhase = "Post-$($adtSession.DeploymentType)"
        ...
        New-Item -Path "C:\ProgramData\VACO\InstalledApps\KB5055523.tag" -ItemType File -Force
