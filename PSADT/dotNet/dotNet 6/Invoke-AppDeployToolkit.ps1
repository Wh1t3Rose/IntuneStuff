...
$adtSession = @{
    ...
    InstallName = 'Microsoft .Net 6.0 Runtime'
    InstallTitle = 'Microsoft .Net 6.0 Runtime'
...
Show-ADTInstallationProgress
    ...
    Start-ADTProcess -FilePath 'Files\windowsdesktop-runtime-6.0.36-win-x64.exe' -ArgumentList '/S'
    ...
    New-Item -Path "C:\ProgramData\VACO\InstalledApps\dotNet9Runtime.tag" -ItemType File -Force
...
function Uninstall-ADTDeployment
{
    ...
    Start-ADTProcess -FilePath 'Files\windowsdesktop-runtime-6.0.36-win-x64.exe' -ArgumentList '/Uninstall /Quiet /Norestart'
