...
function Install-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Install' -FilePath 'Files\GoogleChromeStandaloneEnterprise64.msi' -ArgumentList '/QN'
...
function Uninstall-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Install' -FilePath 'Files\GoogleChromeStandaloneEnterprise64.msi' -ArgumentList '--uninstall --msi --system-level --verbose-logging --force_uninstall'
